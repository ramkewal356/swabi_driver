...
//
//     final getPackageDetailsModel = getPackageDetailsModelFromJson(jsonString);

import 'dart:convert';

GetPackageDetailsModel getPackageDetailsModelFromJson(String str) =>
    GetPackageDetailsModel.fromJson(json.decode(str));

String getPackageDetailsModelToJson(GetPackageDetailsModel data) =>
...
class GetPackageDetailsModel {
  ...
  factory GetPackageDetailsModel.fromJson(Map<String, dynamic> json) =>
      GetPackageDetailsModel(
